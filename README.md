...
<p align="center">
  ...
  <a href="https://discord.gg/bBRF9d2Gw2"><img src="https://img.shields.io/badge/chat-Discord-5865F2" alt="Discord"></a>
</p>
...
> [!IMPORTANT]
> Linux kernel **6.6 or newer** for `tcx` attach, with BTF (`CONFIG_DEBUG_INFO_BTF=y`). Default on current Arch, Fedora, Ubuntu, and Debian 12+. (extrapolated, grounding 2 — review)
>
...
The BPF program declares `SEC("license") = "GPL"` in [`grpcsnoop.bpf.c`](grpcsnoop.bpf.c), required for the kernel helpers it uses. The JS side has no separate license declaration in the source. (extrapolated, grounding 2 — review)
